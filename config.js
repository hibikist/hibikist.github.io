...
const init_phones = ["stargazer","Hibikist 2023 Target"],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
...
const targets = [
    ...
    { type:"Reviewer",   files:["Antdroid","Bad Guy","Banbeucmas","Crinacle","Precogvision","Super Review","Hibikist","Hibikist 2023"] },
...
function watermark(svg) {
    ...
    if ( watermark_text ) {
        wm.append("text")
            .attrs({x:0, y:140, "font-size":20, "text-anchor":"middle", "class":"graph-name"})
            .text(watermark_text);
    }
}
